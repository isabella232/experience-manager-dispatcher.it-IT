---
title: Annullamento della validità delle pagine nella cache da AEM
...
# Annullamento della validità delle pagine nella cache da AEM {#invalidating-cached-pages-from-aem}
...
L'account `admin` utente predefinito viene utilizzato per autenticare gli agenti di replica installati per impostazione predefinita. È necessario creare un account utente dedicato da utilizzare con gli agenti di replica. [](https://helpx.adobe.com/experience-manager/6-3/sites/administering/using/security-checklist.html#VerificationSteps)
...
In alternativa, puoi anche accedere e configurare l’agente Dispatcher Flush dall’interfaccia utente [](https://helpx.adobe.com/experience-manager/6-2/sites/deploying/using/replication.html#ConfiguringaDispatcherFlushagent)AEM Touch.
...
* Tutti i file (di qualsiasi estensione file) denominati `en` nella `geometrixx-outdoors` directory
