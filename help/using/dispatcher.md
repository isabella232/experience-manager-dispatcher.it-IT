...
1. Intestazioni di scadenza e controllo cache\
   La maggior parte dei CDNS prevarranno `Expires:` e `Cache-Control:` le intestazioni HTTP se inviate dal server upstream. Questo può essere ottenuto, ad esempio utilizzando [il modulo mod_ expires](https://httpd.apache.org/docs/2.4/mod/mod_expires.html) Apache.
